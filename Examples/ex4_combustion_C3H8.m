...
TO2=NFP('O2','tsat_P',P0)

TC3H8=NFP('C3H8','tsat_P',P0)
...
deltah_O2=(NFP('O2','h_pT',P0,400)-NFP('O2','hl_P',P0))*NFP('O2','MM'); % kJ/mol
%deltah_O2=0 % uncomment for gas phase propellants
hO2 = HGSsingle('O2','h',400)-deltah_O2 % enthalpy at inlet, in hgs reference


deltah_C3H8=(NFP('C3H8','h_pT',P0,400)-NFP('C3H8','hl_P',P0))*NFP('C3H8','MM'); % kJ/mol
